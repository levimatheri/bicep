        ...
        public async Task<int> RunAsync(string[] args, CancellationToken cancellationToken)
        {
            ...
            try
            {
                switch (ArgumentParser.TryParse(args, services.GetRequiredService<IFileSystem>()))
                {
                    ...
                    case ConsoleArguments consoleArguments when consoleArguments.CommandName == Constants.Command.Console: // bicep console [options]
                        return await services.GetRequiredService<ConsoleCommand>().RunAsync(consoleArguments, cancellationToken);
